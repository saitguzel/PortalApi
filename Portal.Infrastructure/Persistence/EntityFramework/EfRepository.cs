...
namespace Portal.Infrastructure.Persistence.EntityFramework
{
    public class EfRepository<T> : IRepository<T> where T : BaseEntity
    {
        ...
        // hangi model gönderilmişse o dataları dönmesi için
        ...
        // include ile foreign key ile bağlı olunan diğer tablolarda çekilebilir.
        ...
        protected string GetFullErrorTextAndRollbackEntityChanges(DbUpdateException exception)
        {
            if (_context is DbContext dbContext)
            {
                ...
                entries.ForEach(entry =>
                {
                    try
                    {
                        // hata olması durumunda entity nin durumunu unchange çeker 
